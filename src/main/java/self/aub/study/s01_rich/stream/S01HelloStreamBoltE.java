 ...
 */
public class S01HelloStreamBoltE extends BaseBasicBolt {
    private static final Logger LOG = LoggerFactory.getLogger(S01HelloStreamBoltE.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector basicOutputCollector) {
        ...
        LOG.info("blot E recive ========>>  taskId:{} info:{} sourceStreamId:{}, city:{}, tag:{}", taskId, boltInfo,sourceStreamId, city, tag);
