 ...
 */
public class S01HelloStreamBoltD extends BaseBasicBolt {
    private static final Logger LOG = LoggerFactory.getLogger(S01HelloStreamBoltD.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector basicOutputCollector) {
        ...
        LOG.info("blot D recive ========>>  taskId:{} info:{} sourceStreamId:{}, city:{}, tag:{}", taskId, boltInfo,sourceStreamId, city, tag);
