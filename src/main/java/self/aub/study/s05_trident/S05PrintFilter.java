...
/**
 * @author liujinxin
 * @since 2015-07-16 00:20
 */
public class S05PrintFilter extends BaseFilter {
    private static final Logger LOG = LoggerFactory.getLogger(S05PrintFilter.class);
    private String info;
    ...
    public boolean isKeep(TridentTuple tridentTuple) {
        ...
        stringBuilder.append(']');
        LOG.warn("print filter ==>> info:{} value:{} ", info, stringBuilder.toString());
        return true;
    }
}
