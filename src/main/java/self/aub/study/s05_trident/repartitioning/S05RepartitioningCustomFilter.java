 ...
 */
public class S05RepartitioningCustomFilter extends BaseFilter {
    private static final Logger LOG = LoggerFactory.getLogger(S05RepartitioningCustomFilter.class);
    private String info;
