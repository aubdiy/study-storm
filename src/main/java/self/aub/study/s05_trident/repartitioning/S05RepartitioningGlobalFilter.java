 ...
 */
public class S05RepartitioningGlobalFilter extends BaseFilter {
    private static final Logger LOG = LoggerFactory.getLogger(S05RepartitioningGlobalFilter.class);
    private String info;
