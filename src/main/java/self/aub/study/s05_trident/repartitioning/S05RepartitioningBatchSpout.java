 ...
 */
public class S05RepartitioningBatchSpout implements IBatchSpout {
    private static final Logger LOG = LoggerFactory.getLogger(S05RepartitioningBatchSpout.class);
