 ...
 */
public class S05RepartitioningBatchGlobalFilter extends BaseFilter {
    private static final Logger LOG = LoggerFactory.getLogger(S05RepartitioningBatchGlobalFilter.class);
    private String info;
